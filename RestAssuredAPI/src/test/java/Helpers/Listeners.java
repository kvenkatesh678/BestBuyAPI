...
public class Listeners extends TestListenerAdapter{
	...
	public static String file="C:/Users/user/eclipse-workspace/RestAssuredAPI/Reports/BestBuyAPI's.html";
	...
	public void onStart(ITestContext testContext) {
		...
		Reporter.config().setReportName("RestAssured API Testing");
...
//		test.log(Status.INFO, "TestCase Started is :" +result.getName());
	}
	
	public void onTestFailure(ITestResult tr) {
		test = extent.createTest(tr.getName());
		test.log(Status.INFO, "TestCase Started is :" +tr.getName());
		test.log(Status.INFO, "TestCase failed  is :" +tr.getName());
